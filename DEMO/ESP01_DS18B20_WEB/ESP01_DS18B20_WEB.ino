//ESP8266和DS18B20的網絡溫度傳感器http://www.elec-cafe.com/temperature-sensor-on-the-web-with-esp8266-and-ds18b20/
...
void loop() {
  ...
  client.println("Connection: close");  // 連接將在完成響應後關閉
  client.println("Refresh: 5");  // 每5秒自動刷新頁面
  client.println();
